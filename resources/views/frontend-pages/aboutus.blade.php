    ...
    <div class="container">
        ...
        <section class="section">
            ...
            <div class="about-content">
                <p class="d_mode">If you forget your password, I won't tell you who you are.</p>
                <ul>
                    <li class="d_mode">Click on "Forgot password?" or "Need account?" - this is usually under the password field.</li>
                    <li class="d_mode">Enter your email or username associated with the account.</li>
                    <li class="d_mode">Check your email for the reset link - it might be in your spam folder too.</li>
                    <li class="d_mode">Click the link in the email to reset your password - the link expires so don't wait too long.</li>
                    <li class="d_mode">If you don't get an email or it didn't recover your account, look for a "Contact Support" option on the website.</li>
                </ul>
            </div>
        </section>
        ...
        <section class="section team-section">
            ...
            <div class="team-role">
                <h3 class="d_mode">Project Manager</h3>
                <div class="team-grid">
                    <div class="team-member">
                        <img src="img/AboutUs_Profile/image.png" alt="J.K ROWLING" class="member-photo">
                        <div class="member-name d_mode">J.K ROWLING</div>
                    </div>
                    <div class="team-member">
                        <img src="img/AboutUs_Profile/image.png" alt="J.K ROWLING" class="member-photo">
                        <div class="member-name d_mode">J.K ROWLING</div>
            ...
            <div class="team-role">
                <h3 class="d_mode">Developer Team</h3>
                <div class="team-grid">
                    <div class="team-member">
                        <img src="img/AboutUs_Profile/image.png" alt="J.K ROWLING" class="member-photo">
                        <div class="member-name d_mode">J.K ROWLING</div>
